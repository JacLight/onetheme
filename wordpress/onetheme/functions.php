...
if ( ! function_exists( 'onetheme_setup' ) ) :
	...
	function onetheme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'onetheme' ),
		) );
...
function onetheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'onetheme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'onetheme' ),
...
add_action( 'wp_enqueue_scripts', 'onetheme_scripts' );
